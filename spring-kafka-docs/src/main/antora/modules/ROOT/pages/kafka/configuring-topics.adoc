...
* | Kafka v2.6+ & Kafka Broker v2.4.0+ -> you can (check https://cwiki.apache.org/confluence/display/KAFKA/KIP-464%3A+Defaults+for+AdminClient%23createTopic[KIP-464]) omit
    ** `partitions()`
